...
ErrorOr<Process> Process::spawn(ProcessSpawnOptions const& options)
{
    ...
    if (windows_options.startup_type == StartupType::Unspecified)
    ...
    BOOL result;
    auto saved_last_err;
    if (windows_options.startup_type == StartupType::AttributeList) {
        ...
        startup_info_ex.lpAttributeList = windows_options.startup_value;
        ...
        result = CreateProcessAsUserW(
            windows_options.startup_value, // low-privileged token to run as
            NULL,                          // application name
            (char*)command_line.data(),    // process to run
            NULL,                          // process security attributes
            NULL,                          // primary thread security attributes
