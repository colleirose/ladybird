...
WEB_API ErrorOr<ByteBuffer> get_buffer_source_copy(JS::Object const& buffer_source, ByteBuffer::EraseBufferOnFree erase_option = ByteBuffer::EraseBufferOnFree::Unspecified);
